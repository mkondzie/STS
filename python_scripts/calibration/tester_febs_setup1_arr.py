...
def reading_lv(pol_usr = 'N'):
    ...
    if (pol == 'N' or pol == '0'):
        ...
        os.system("./../../../lv/mpod_hhlab_2024/lab24_mpod02_u404 voltage | grep -Eo '[0-9]+([.][0-9]+)' > lv_iv.txt")
        os.system("./../../../lv/mpod_hhlab_2024/lab24_mpod02_u405 voltage | grep -Eo '[0-9]+([.][0-9]+)' >> lv_iv.txt")
    elif(pol == 'P' or pol == '1'):
        print("Reading LV for P-side (holes polarity):")
        #Reading Voltage and current values and writting them in a file                                                               
        os.system("./../../../lv/mpod_hhlab_2024/lab24_mpod02_u406 voltage | grep -Eo '[0-9]+([.][0-9]+)' > lv_iv.txt")
        os.system("./../../../lv/mpod_hhlab_2024/lab24_mpod02_u407 voltage | grep -Eo '[0-9]+([.][0-9]+)' >> lv_iv.txt")
    else:
    ...
    for asic_sw in feb_type_sw:
        for smx in smx_l_side:
            ...
            if ((smx.address == asic_sw) and (smx.address in cal_asic_list)):
                ...
                #smx.write(130, 18, 114)
                #print(smx.read(130, 18)&0xff)
                log.info(info)
...
# +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
emu_list = ["EMU_213"]                           #["EMU_213"]     # List of EMU boards used during the test
...
#disc_list = [20, 22, 24, 26, 28, 30, 31]
