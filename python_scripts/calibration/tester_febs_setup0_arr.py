...
def reading_lv(pol_usr = 'N'):
    ...
    if (pol == 'N' or pol == '0'):
        ...
        os.system("./../../../lv/mpod_hhlab_2024/lab24_mpod02_u400 voltage | grep -Eo '[0-9]+([.][0-9]+)' > lv_iv.txt")
        os.system("./../../../lv/mpod_hhlab_2024/lab24_mpod02_u401 voltage | grep -Eo '[0-9]+([.][0-9]+)' >> lv_iv.txt")
    elif(pol == 'P' or pol == '1'):
        print("Reading LV for P-side (holes polarity):")
        #Reading Voltage and current values and writting them in a file                                                               
        os.system("./../../../lv/mpod_hhlab_2024/lab24_mpod02_u402 voltage | grep -Eo '[0-9]+([.][0-9]+)' > lv_iv.txt")
        os.system("./../../../lv/mpod_hhlab_2024/lab24_mpod02_u403 voltage | grep -Eo '[0-9]+([.][0-9]+)' >> lv_iv.txt")
    else:
...
# +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
emu_list = ["EMU_238"]                           #["EMU_213"]     # List of EMU boards used during the test
